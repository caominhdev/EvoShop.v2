...
public partial class CheckoutComplete : System.Web.UI.Page
{
    ...
    public bool ValidateCheckout()
    {
        ...
        {
            isCheckoutOk = true;
            ucMessage.ShowSuccess("Xin chúc mừng, đơn hàng đã được thanh toán thanh công. Chúng tôi sẽ giao hàng trong thời gian sớm nhất. <a href='OrderDetail.aspx'>Xem đơn hàng</a>");
        }
        else
        {
            isCheckoutOk = false;
            ucMessage.ShowError("Rất tiếc, đơn hàng chưa được thanh toán thanh công. Vui lòng kiểm tra lại hoặc <a href='OrderDetail.aspx'>Xem đơn hàng</a>");
        }
